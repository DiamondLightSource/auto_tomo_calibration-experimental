...
#qsub -pe smp 2 -j y -t 2 -tc 10 ~/auto_tomo_calibration-experimental/Analysis_Cluster/run_auto_calib.sh /dls/tmp/jjl36382/spheres/sphere%02i.npy /dls/tmp/jjl36382/spheres/sphere_3gaus%02i.npy
...
do
	...
	qsub -pe smp 2 -j y -t $start-$final:$step -tc 15 ~/auto_tomo_calibration-experimental/Analysis_Cluster/run_auto_calib.sh /dls/tmp/jjl36382/spheres/sphere_3gaus02.npy /dls/tmp/jjl36382/radii$i/radii%03i.npy
