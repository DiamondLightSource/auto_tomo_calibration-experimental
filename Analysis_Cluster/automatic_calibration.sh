...
# Detect circles ------------------------------------------------------------------------------------------------------
echo "module load python/ana" > ~/auto_tomo_calibration-experimental/Analysis_Cluster/test_run.sh
...
#echo qsub -pe smp 2 -j y -t $start:$final:$step -tc 15 ~/auto_tomo_calibration-experimental/Analysis_Cluster/test_run.sh $path"recon_%05i.tif" /dls/tmp/jjl36382/results/out%05i.dat
...
#qsub -pe smp 2 -j y -t 1 ~/auto_tomo_calibration-experimental/Analysis_Cluster/test_run.sh 
...
do	
	...
	#qsub -pe smp 2 -j y -t 2 -tc 10 ~/auto_tomo_calibration-experimental/Analysis_Cluster/test_run.sh /dls/tmp/jjl36382/spheres/sphere0$i.npy /dls/tmp/jjl36382/spheres/sphere_auto$i.npy
done
...
do
	...
	#echo qsub -pe smp 2 -j y -t $start-$final:$step -tc 15 ~/auto_tomo_calibration-experimental/Analysis_Cluster/test_run.sh /dls/tmp/jjl36382/spheres/sphere_median02.npy /dls/tmp/jjl36382/radii/radii%03i.npy
done 
...
#echo "start running"
#echo "module load python/ana" > ~/auto_tomo_calibration-experimental/Analysis_Cluster/test_run.sh
#echo "cd /dls/tmp/jjl36382/logs" > ~/auto_tomo_calibration-experimental/Analysis_Cluster/test_run.sh
