...
#/dls/science/groups/i12/for\ Tomas/pco1-45808.hdf
...
qsub -pe smp 2 -j y -t 1:2101:10 -tc 15 ~/auto_tomo_calibration-experimental/Analysis_Cluster/run_auto_calib.sh "/dls/science/groups/i12/for*Tomas/pco1-45808.hdf" /dls/tmp/jjl36382/results/out%05i.dat

#echo "cd \$@" >> ~/auto_tomo_calibration-experimental/Analysis_Cluster/run_auto_calib.sh
#~/auto_tomo_calibration-experimental/Analysis_Cluster/run_auto_calib.sh "/dls/science/groups/i12/for*Tomas" # /dls/tmp/jjl36382/results/out%05i.dat
...
#echo "module load python/ana" > ~/auto_tomo_calibration-experimental/Analysis_Cluster/run_auto_calib.sh
#echo "cd /dls/tmp/jjl36382/logs" >> ~/auto_tomo_calibration-experimental/Analysis_Cluster/run_auto_calib.sh
#echo "python ~/auto_tomo_calibration-experimental/Analysis_Cluster/analyse.py -a 0 -b 2100 -c 10 /dls/tmp/jjl36382/results/out%05i.dat" >> ~/auto_tomo_calibration-experimental/Analysis_Cluster/run_auto_calib.sh
