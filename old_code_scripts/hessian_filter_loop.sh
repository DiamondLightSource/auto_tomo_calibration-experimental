...
do
	...
	cd $spherepath/sphere_hessian$i/
	...
	qsub -hold_jid job3 -N job4 -pe smp 2 -j y -t $i -tc 20 $homepath/hessian_filter.sh $spherepath/sphere_hessian$i $spherepath/sphere$i.mhd $sigma
done
